...
@require_permission_v2("admin.user_management")
async def list_all_auth_events(limit: int = 100, offset: int = 0, user_email: Optional[str] = None, current_user_ctx: dict = Depends(get_current_user_with_permissions)):    """List authentication events for all users (admin only).
...
@require_permission_v2("admin.user_management")
async def create_user(user_request: EmailRegistrationRequest, current_user_ctx: dict = Depends(get_current_user_with_permissions)):    """Create a new user account (admin only).
...
@require_permission_v2("admin.user_management")
async def get_user(user_email: str, current_user_ctx: dict = Depends(get_current_user_with_permissions)):    """Get user by email (admin only).
...
=======
@require_permission_v2("admin.user_management")
async def update_user(user_email: str, user_request: EmailRegistrationRequest, current_user_ctx: dict = Depends(get_current_user_with_permissions)):    """Update user information (admin only).
>>>>>>> 18df0612 (feat(phase1): complete decorator migration to PolicyEngine)
...
@require_permission_v2("admin.user_management")
async def delete_user(user_email: str, current_user_ctx: dict = Depends(get_current_user_with_permissions)):    """Delete/deactivate user (admin only).
